...
import com.google.common.io.Files;
	...
	/**
	 * contains all reusuable actions of webdriver
	 * @author Darshan
	 *
	 */
	public class WebDriverUtility {
	/**
	 * it is an implicitly wait always wait for element in DOM document and release the control if element available
	 * @param driver
	 */
	...
	/**
	 * it will check for the element in the GUI for polling time of 500millisec
	 * @param driver
	 * @param element
	 */
	...
	/**
	 * it will check foe the title in the GUI for polling time of 500ms
	 * @param driver
	 * @param title
	 */
	...
	/**
	 * here ew are giving custom timeout
	 * @param element
	 ...
	 * @param visible_text
	 */
	 public void selectDropDownByText(WebElement element,String visible_text) {
		 Select select=new Select(element);
